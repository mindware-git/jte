...
static func _get_first_dialogue() -> DialogueData:
	return DialogueData.with_choices(
		"DIALOGUE_BLUFFING_ELDER_FIRST",
		"DIALOGUE_BLUFFING_ELDER_FIRST_TEXT",
		[
			# 비싼 약주를 사준다 (100금)
			DialogueData.DialogueChoice.create(
				"CHOICE_BUY_WINE",
				"DIALOGUE_BLUFFING_ELDER_BUY_WINE",
				[
					DialogueData.DialogueAction.take_money(100),
			...
			DialogueData.DialogueChoice.create(
				"CHOICE_DECLINE",
				"DIALOGUE_BLUFFING_ELDER_DECLINE",
				[
...
static func _get_hint_dialogue() -> DialogueData:
	return DialogueData.with_choices(
		"DIALOGUE_BLUFFING_ELDER_HINT",
		"DIALOGUE_BLUFFING_ELDER_HINT_TEXT",
		[
			# 힌트를 듣는다
			DialogueData.DialogueChoice.create(
				"CHOICE_LISTEN_HINT",
				"DIALOGUE_BLUFFING_ELDER_RECEIVE_HINT",
				[
...
static func _get_repeat_dialogue() -> DialogueData:
	return DialogueData.simple(
		"DIALOGUE_BLUFFING_ELDER_REPEAT",
		"DIALOGUE_BLUFFING_ELDER_REPEAT_TEXT"
	)